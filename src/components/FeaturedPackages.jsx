...
const packages = [
  {
    ...
    rating: 4.8,
    price: "$299",
    description: "Fly high with paragliding, explore serene lakes, and enjoy the stunning views of the Himalayas.",
  },
  {
    id: 2,
    ...
    rating: 4.6,
    price: "$199",
    description: "Dive into ancient history with visits to temples, stupas, and traditional architecture in the capital.",
  },
  {
    id: 3,
    ...
    rating: 4.9,
    price: "$249",
    description: "Reconnect with peace and spirituality in the birthplace of Lord Buddha through guided temple tours.",
  },
];
