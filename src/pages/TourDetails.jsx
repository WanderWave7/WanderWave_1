  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[400px] overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/70 to-transparent px-10 py-6"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-6 lg:px-20 py-10">
        ...
        <div className="md:col-span-3 space-y-8">
          ...
          <SectionWrapper delay={0.3} className="space-y-4">
            <motion.h2
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              {tour.itinerary.map((item, index) => (
                <motion.li
                  key={index}
                  variants={fadeIn("right", "spring", index * 0.1 + 0.2, 0.5)}
                >
        ...
        >
          <motion.div
            className="bg-white shadow-md p-6 rounded-xl sticky top-24"
